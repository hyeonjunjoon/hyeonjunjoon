...
### [Fampay — XRPL 기반 가족 그룹 지갑](https://github.com/XRPL-Fampay/Fampay_backend)
XRPL Credential 기반 그룹 멤버십 인증과 Multi-signature 트랜잭션 처리를 구현한 백엔드 서버 (Node.js, Express, Prisma)
